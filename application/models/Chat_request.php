...
class Chat_request extends CP_Model {
    ...
    public function forward_to_agents($user_id, $visitor_id, $device_id = '') {
        ...
        foreach ($created_requests as $key => $request) {
            ...
            $notification_data['message'] = $agent->name . " forward you a request.";
            $notification_data['display_message'] = $agent->name . " forward you a request.";
            ...
            $message['message'] = $agent->name . " forward you a request.";
            $message['displayMessage'] = $agent->name . " forward you a request.";
        ...
        $user_message = array('chat_session_id' => $this->model_data['chat_session_id'], 'sender_id' => $agent->id, 'chat_message' => 'I m forwarding your request to another Agent.');
        ...
        if ($message_id and is_object($message_id) === false) {
            ...
            $message['message'] = 'I m forwarding your request to another Agent.';
            $message['displayMessage'] = $agent->name . " forwarded request to another Agent.";
