...
class Migration_Add_offline_requests extends CI_Migration {
    ...
    public function up() {
        $this->dbforge->add_field(array(
            ...
            'CONSTRAINT FOREIGN KEY (visitor_id) REFERENCES ' . $this->db->dbprefix . 'users(id) ON DELETE CASCADE ON UPDATE CASCADE',
            'CONSTRAINT FOREIGN KEY (address_id) REFERENCES ' . $this->db->dbprefix . 'user_address(id) ON DELETE CASCADE ON UPDATE CASCADE'
        ));
