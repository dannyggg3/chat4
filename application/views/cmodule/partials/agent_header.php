    ...
    <div ng-show="visible_area == 'new-requests'" class="chat-section">
        <div class="container-header-secondary">
            <div class="header-fixed clearfix">
                <div class="pull-left">
                    <h2 class="text-danger"><span class="icon-circle"><i class="icon-bg icon-online"></i></span><?php echo $this->lang->line('new_requests'); ?></h2>
                </div>
            ...
            <div class="col-xs-12">
                <div class="user-container">
                    <div class="user-entry" ng-repeat="row in new_requests">
                        ...
                        <div class="user-head-block clearfix" ng-show="row.request_type == 'forward'" ng-init="rand_color = getColor()">
