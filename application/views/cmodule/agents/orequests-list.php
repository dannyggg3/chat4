        ...
        <div class="col-xs-12">
            <div class="container-header-secondary">
                <div class="header-fixed clearfix">
                    <div class="pull-left">
                        <h2 class="text-danger"><span class="icon-circle"><i class="icon-bg icon-offline"></i></span><?php echo $this->lang->line('offline_requests'); ?></h2>
                    </div>
                            ...
                            <div class="modal-body">
                                <div class="row">        
                                    <div class="col-xs-12">
                                        ...
                                        <form name="chatForm" id="chatForm" action="" method="post" ng-submit="send_message($event)">
