(function () {
    app.controller("RequestController", function ($scope, $http) {
        ...
        $scope.load_more = function () {
            ...
            $http.post(site_url + "?c=orequests&m=get_requests", {offset: $scope.offset}).success(function (data) {
                if (data.length == 0) {
        ...
        $scope.get_conversations = function (request) {
            ...
            $http.post(site_url + "?c=orequests&m=get_conversations&id=" + request.id).success(function (data) {
